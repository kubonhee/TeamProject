 ...
 <!-- Result Modal-->
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    <li><a href="${pageContext.request.contextPath}/board/register" class="mb-10" style="">판매하기</a></li>
                    <li class="active"><a href="/">Home</a></li>
                    
                    <c:if test="${member != 'anonymousUser'}">
                    	<li><a href="${pageContext.request.contextPath}/nearList">Near</a></li> 
                    </c:if>
                    <li><a href="${pageContext.request.contextPath}/board/category?cate=1">여성의류/잡화</a></li>
                    <li><a href="${pageContext.request.contextPath}/board/category?cate=2">남성의류/잡화</a></li>
                    <li><a href="${pageContext.request.contextPath}/board/category?cate=3">디지털/가전</a></li>
                    <li><a href="${pageContext.request.contextPath}/board/category?cate=4">가구/생활</a></li>
                    <li><a href="${pageContext.request.contextPath}/board/category?cate=5">스포츠/레저</a></li>
                    <li><a href="${pageContext.request.contextPath}/board/category?cate=6">아동의류</a></li>
                    <li><a href="${pageContext.request.contextPath}/board/category?cate=7">아동잡화</a></li>
                    <li><a href="${pageContext.request.contextPath}/board/category?cate=8">도서/취미</a></li>
                    <li><a href="${pageContext.request.contextPath}/board/category?cate=9">차량/오토바이</a></li>
                    <li><a href="${pageContext.request.contextPath}/board/category?cate=10">무료나눔</a></li>
                </ul>
            </nav>
